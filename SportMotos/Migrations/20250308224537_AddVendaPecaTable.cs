...
{
    /// <inheritdoc />
    public partial class AddVendaPecaTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoProduto = table.Column<string>(type: "VARCHAR(10)", unicode: false, maxLength: 10, nullable: false),
                    Quantidade = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    Data_Adicionado = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data_Edicao = table.Column<DateTime>(type: "datetime", nullable: true),
                    Apagado_Em = table.Column<DateTime>(type: "datetime", nullable: true),
                    Resposta = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Forum__0503F940E68FFBFC", x => x.ID_Forum);
                    table.ForeignKey(
                        name: "FK__Forum__ID_Client__5EBF139D",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InteresseMotos_Cliente_IdCliente",
                        column: x => x.IdCliente,
                        principalTable: "Cliente",
                        principalColumn: "ID_Cliente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InteresseMotos_Moto_IdMoto",
                        column: x => x.IdMoto,
                        principalTable: "Moto",
                        principalColumn: "ID_Moto",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orcament__0503F9406E8490D9", x => x.ID_Forum);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoCompras_IdCliente",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "PecaId",
                unique: true,
                filter: "[PecaId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_InteresseMotos_IdCliente",
                table: "InteresseMotos",
                column: "IdCliente");

            migrationBuilder.CreateIndex(
                name: "IX_InteresseMotos_IdMoto",
                table: "InteresseMotos",
                column: "IdMoto");
